    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.onSinglePicker:
                ...
                picker3.setRange(0, 25, 0.1);//数字范围
                    ...
                    if (result.getData() != null) {
                        ...
                        if (!StringUtil.isEmpty(pressureType)) {
                            ...
                            if (level.equals(SugarTypeEnum.LOW.getCode())) {
                                ...
                                //ToastUtil.showToastLong(SugarActivity.this,"温馨提示:"+ SugarTypeEnum.LOW.getMsg());
                            }
                            if (level.equals(SugarTypeEnum.NORMAL.getCode())) {
                                level2.setImageResource(R.drawable.level_active);
                                //ToastUtil.showToastLong(SugarActivity.this,"温馨提示:"+ SugarTypeEnum.NORMAL.getMsg());
                            }
                            if (level.equals(SugarTypeEnum.HIGH.getCode())) {
                                level3.setImageResource(R.drawable.level_active);
                                //ToastUtil.showToastLong(SugarActivity.this,"温馨提示:"+ SugarTypeEnum.HIGH.getMsg());
                            }
                            if (level.equals(SugarTypeEnum.SERIOUS.getCode())) {
                                level4.setImageResource(R.drawable.level_active);
                                //ToastUtil.showToastLong(SugarActivity.this,"温馨提示:"+ SugarTypeEnum.SERIOUS.getMsg());
                            }
                        }
                    }
                } else {
                    ToastUtil.showToast(SugarActivity.this, "获取信息失败");
                }
            }
        });
    }
