 ...
 */
public class DemoHttpRecyclerActivity extends BaseHttpRecyclerActivity<User, UserView, UserAdapter> implements OnBottomDragListener {
    ...
    public static Intent createIntent(Context context, int range) {
        return new Intent(context, DemoHttpRecyclerActivity.class).putExtra(INTENT_RANGE, range);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.demo_http_recycler_activity, this);
